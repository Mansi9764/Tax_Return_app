...
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:retail_tax_filing_app/screenss/OTPSuccess.dart';  // Ensure this is the correct path.
...
class _EnterOtpScreenState extends State<EnterOtpScreen> {
  ...
  void _verifyOTP() async {
    ...
    try {
      ...
      // Navigation on successful OTP verification
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => OtpSuccessPage()), // Assume OtpSuccessPage is the correct success page.
      );
